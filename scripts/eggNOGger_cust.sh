...
export INPUT_FILE=$(ls /vortexfs1/omics/env-bio/collaboration/genome-streamlining/data/Proteins/AAA076-D13*)
...
OUTPUT="${OUTPUT_DIR}/$(basename ${INPUT_FILE} .faa)_maNOG.txt"

echo -e "Query name: ${INPUT_FILE}\nOutfile: ${OUTPUT}\n"

python2.7 /vortexfs1/home/ngermolus/eggnog-mapper/emapper.py -i ${INPUT_FILE} --output ${OUTPUT} \
-m diamond #--dmnd_db 
